...
//#include "../ref_load/xreference_loader.h"
...
//    results->x = XSubseek_dtw_Get_agg_result_x(&haru->sdtw);
//    results->y = XSubseek_dtw_Get_agg_result_y(&haru->sdtw);
    printf("============================\n");
}
